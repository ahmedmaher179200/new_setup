<header class="main-header">
    ...
    <a href="#" class="logo">
        ...
        <span class="logo-mini">housing unit</span>
        <span class="logo-lg">housing unit</span>
    </a>
                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            ...
                            <a href="{{url('dashboard/logout')}}" class="btn btn-default btn-flat">{{ trans('admin.logout') }}</a>
