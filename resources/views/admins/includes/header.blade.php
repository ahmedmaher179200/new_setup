...
<head>
  ...
  <!-- SweetAlert2 -->
  <link rel="stylesheet" href="{{ asset('admin/dashboard/plugins/sweetalert2-theme-bootstrap-4/bootstrap-4.min.css')}}">
  <!-- Toastr -->
  <link rel="stylesheet" href="{{ asset('admin/dashboard/plugins/toastr/toastr.min.css')}}">
  <link rel="stylesheet" href="{{ asset('admin/dashboard/dist/css/custom.css')}}">
  ...
  @if (app()->getLocale() == 'ar')
    ...
    <link rel="stylesheet" href="{{ asset('admin/dashboard/dist/css/custom-rtl.css')}}">
  @else
      <link rel="stylesheet"
...
<div class="preloader flex-column justify-content-center align-items-center">
  <img class="animation__shake" src="{{ asset('admin/dashboard/dist/img/AdminLTELogo.png')}}" alt="AdminLTELogo" height="60" width="60">
</div>
