    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li> <a href="#"><i class="fa fa-users"></i>{{ trans('admin.main category') }}</a></li>
                ...
                <div class="box-body">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        @foreach(config('translatable.locales') as $locale)
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>{{ trans('admin.name in') }} {{$locale}}</label>
                                    <input type="text" class="form-control  @error('name') is-invalid @enderror" name="main_categories[{{$locale}}][name]"
                                        placeholder="{{ trans('admin.name') }}" value="{{$main_category->translate($locale)->name}}" required autocomplete="off">
                                    @error('name')
                                        <small class=" text text-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </small>
